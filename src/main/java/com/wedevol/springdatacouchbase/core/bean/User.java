package com.wedevol.springdatacouchbase.core.bean;

import java.util.Map;

/**
 * Represents an incoming message from FCM Server
 * 
 * @author Charz++
 */
public class User {
	...
	public User(String from, String category, String messageId, Map<String, String> dataPayload) {
		this.from = from;
